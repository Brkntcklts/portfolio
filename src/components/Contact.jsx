        ...
        {isOpen && (
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-[600px] max-h-[90vh] overflow-y-auto bg-zinc-900 border border-emerald-400/20 rounded-sm shadow-[0_0_30px_rgba(52,211,153,0.1)] p-4 sm:p-8"
            >
              {/* Close Button */}
              <button
                onClick={toggleModal}
